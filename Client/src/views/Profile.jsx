...
export default function Profile() {
    ...
    return (
            ...
            <section className="w-fit h-fit p-[20px] bg-[#202020] flex flex-col gap-8 mt-[40px] rounded-md">
                ...
                <Link className="text-[24px] font-bold bg-[#90EE90] p-3 rounded-3xl cursor-pointer hover:bg-[#73c073] w-[250px] text-center" to={'/profile/edit/' + user.id}>Edit profile</Link>
                }
