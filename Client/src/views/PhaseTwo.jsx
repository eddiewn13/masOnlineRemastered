        ...
        <section className="w-screen h-screen  flex flex-col  justify-center items-center">
            <div className="w-fit flex flex-col gap-[60px] justify-center items-center">
                ...
                <div className="flex items-center justify-between w-full ">
                    <Link to={'/guide'}>
                        <img src="./bilder/arrow.png" alt="<-" className="text-[50px] w-[50] h-[50px] hover:opacity-60 transition-all hover:scale-105"/>
                    </Link>
                    <Link to={'/phaseOne'}>
                        <h1 className="text-[28px] hover:opacity-60 transition-all hover:scale-105">Prev</h1>
                    </Link>
                </div>
